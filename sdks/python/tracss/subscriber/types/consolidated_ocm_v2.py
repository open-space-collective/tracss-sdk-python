...
class ConsolidatedOcmV2(UncheckedBaseModel):
    ...
    ops_status_raw: typing_extensions.Annotated[
        typing.Optional[typing.List[str]], FieldMetadata(alias="opsStatusRaw"), pydantic.Field(alias="opsStatusRaw")
    ] = None
